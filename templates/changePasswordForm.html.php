...
<div class = "col-lg-12 col-md-12">
    <div class="col-lg-offset-3 col-lg-6 col-md-offset-3 col-md-6">
        <form id="changePasswordForm" class="centered-form" action="http://{$smarty.server.HTTP_HOST}{$subdir}?controller=Verification&action=verificationForm" method="POST" style="margin-top: 15px">
            <legend class="text-center text-info" ">Zmiana hasła</legend>
            <div class="form-group">
                <label for="OldPassword" style="margin-top: -7px">Stare hasło</label>
                <input type="password" class="form-control" id="OldPassword" name="OldPassword" placeholder="Stare hasło" required="required"/>
            </div>
            <div class="form-group">
                <label for="NewPassword" style="margin-top: -7px">Nowe hasło</label>
                <input type="password" class="form-control" id="NewPassword" name="NewPassword" placeholder="Nowe hasło" required="required"/>
            </div>
            <div class="form-group">
                <label for="NewPasswordAgain" style="margin-top: -7px">Powtórz nowe hasło</label>
